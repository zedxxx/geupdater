...
var
  ...
  VDateTime: TDateTime;
begin
  VBuildTime := GetImageLinkTimeStamp(Paramstr(0));
  VDateTime := UnixToDateTime(VBuildTime, True);
  txtBuild.Caption := 'Build: ' + FormatDateTime('yyyy-mm-dd hh:nn:ss', VDateTime) + ' UTC';
  txtCopyright.Caption := 'Copyright ' + #169 + ' 2009-' + FormatDateTime('yyyy', VDateTime) + ', zed';
end;
